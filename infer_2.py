...
x_trg, sr = torchaudio.load(f'/mnt/workspace/guanzifan/eval_tmp/solo/irf10/irf10_s20_solo.wav')
spkemb = speaker_model.infer_segment(x_trg.squeeze(0))[0]

x, sr = torchaudio.load('/mnt/workspace/guanzifan/eval_tmp/chains/whsp/irf10/irf10_s09_whsp.wav')
