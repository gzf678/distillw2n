...
x_trg, sr = torchaudio.load(f'/mnt/workspace/guanzifan/wtimit_16k/aligned_data/whisper/SG/000/s000u204w.WAV')
spkemb = speaker_model.infer_segment(x_trg.squeeze(0))[0]

x, sr = torchaudio.load('/mnt/workspace/guanzifan/wtimit_16k/aligned_data/whisper/SG/000/s000u212w.WAV')
...
torchaudio.save('/mnt/workspace/guanzifan/data/example/output/distillw2n/wtimit_train_align/gzf.wav', z.squeeze(1).detach().cpu(), 16000)